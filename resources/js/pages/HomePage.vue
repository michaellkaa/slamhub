<template>
  <div class="bg-[#0f0f12] w-full min-h-screen flex flex-col lg:flex-row overflow-hidden">
    ...
    <div class="flex-1 flex gap-6 lg:p-6 overflow-hidden no-scrollbar">
      <div
        class="flex-1 lg:p-4 overflow-y-auto h-screen lg:h-[calc(100vh-3rem)] max-h-full no-scrollbar touch-pan-y overscroll-y-contain snap-y snap-mandatory pb-36 lg:pb-0"
        ...
        <div v-for="video in videos" :key="video.id"
          class="mb-4 flex flex-col items-center justify-center snap-start h-[100svh] lg:h-[calc(100vh-3rem)]"
            ...
            <div
              ...
              <div class="absolute right-3 top-1/2 -translate-y-1/2 flex flex-col items-center gap-4 z-20">
                ...
                <button type="button" class="inline-flex flex-col items-center transition"
                  :class="video.liked_by_me ? 'text-red-500' : 'text-white'" @click="toggleLike(video)">
                ...
                <button type="button" class="inline-flex flex-col items-center text-white"
                  ...
                  <svg viewBox="0 0 24 24" class="w-7 h-7 lg:w-6 lg:h-6" fill="none" stroke="currentColor"
                    stroke-width="2">
