  ...
  <div class="flex flex-col gap-4 w-full">
    ...
    >
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
        <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303C33.651 32.656 29.155 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"/>
        ...
        <path fill="#4CAF50" d="M24 44c5.052 0 9.735-1.934 13.243-5.078l-6.115-5.174C29.084 35.186 26.684 36 24 36c-5.134 0-9.618-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z"/>
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.223-2.231 4.114-4.175 5.247l.002-.001 6.115 5.174C36.813 39.02 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"/>
      </svg>
