<template>
  <div class="flex flex-col gap-4 w-full">
    ...
    <input type="email" name="email" autocomplete="email" v-model="email" placeholder="např. novak@email.cz"
    ...
    <input type="password" name="password" autocomplete="current-password" v-model="password" placeholder="••••••••"
      class="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none focus:border-pink-400/50 focus:ring-2 focus:ring-pink-400/20" />
